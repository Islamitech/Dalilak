...
- **حالة الدفعات:** تم إنجاز UXB-01 و UXB-02 و UXB-03 بنجاح 100%
...
| **`UXB-03`** | `UXCH-08`, `UXCH-09`, `UXCH-10`, `UXCH-11` | `src/App.tsx`, `src/components/BottomNav.tsx`, `src/components/business-form/FormOwnerInfoSection.tsx`, `src/components/business-form/InterestedLeadSection.tsx`, `src/components/leads/LeadAddForm.tsx`, `src/components/directory/DirectoryGridCard.tsx`, `src/components/directory/DirectoryListRow.tsx` | لا توجد | اعتماد وتوجيه سيادي مباشر (UXAP-0004) | منجز ومحقق 100% | اختبارات Vitest (60/60) + فحص البناء `tsc --noEmit` سليم 100% | استعادة النسخة السابقة عبر Git |
