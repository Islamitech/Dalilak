...
app.use((_req, res, next) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' https://unpkg.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://unpkg.com https://cdn.jsdelivr.net; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https://*.supabase.co https://*.googleusercontent.com https://*.ggpht.com https://*.tile.openstreetmap.org https://*.tile.openstreetmap.fr https://*.openstreetmap.fr https://unpkg.com https://dalilaak.com https://www.dalilaak.com https://cdn.jsdelivr.net; media-src 'self' data: blob: https://*.supabase.co; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://places.googleapis.com https://unpkg.com https://cdn.jsdelivr.net https://*.openstreetmap.fr; frame-ancestors 'self'; object-src 'none'; base-uri 'self';"
  );
