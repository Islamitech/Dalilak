  ...
  const modalFooter = (
    <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-3">
      {onOpenTerms ? (
        ...
        >
          الاطلاع على شروط وأحكام الاستخدام
        </Button>
      ) : <div />}
  ...
  return (
    <>
      <BaseModal
        isOpen={true}
        onClose={onClose}
        title="من نحن - منصة دليلك الشاملة"
        subtitle="المنظومة الرقمية الرائدة لرقمنة وتنمية الأعمال في مصر"
        ...
        <div className="space-y-6" dir="rtl">
          ...
          <div className="text-center space-y-2 pt-1 border-b border-[var(--border-color)] pb-4">
            ...
            <h2 className="font-black text-xl sm:text-2xl text-[var(--text-primary)]">
              منصة دليلك الشاملة لرقمنة وتنمية الأعمال
            </h2>
          ...
          {/* Headquarters & Office Tour Gallery */}
