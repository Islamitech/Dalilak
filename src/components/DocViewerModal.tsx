          ...
          {docType === 'field_letter' && (
            <div className="space-y-4 text-xs leading-relaxed text-slate-800">
              ...
              <div className="space-y-2 text-justify text-slate-700">
                <p>
                  تشهد **منصة دليلك لخدمات الخرائط والتأكيد الميداني** بأن السيد/ **{rep.name}** هو مندوب مسح وتوثيق ميداني معتمد ومكلف رسمياً بالعمل في نطاق **محافظة {rep.governorate}**.
                </p>
                <p>
            ...
            <div className="space-y-4 text-xs leading-relaxed text-slate-800 max-h-[60vh] overflow-y-auto pr-1">
              ...
              <div className="space-y-1 bg-slate-50/70 p-3 rounded-xl border border-slate-200">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-1 pl-2 text-[11px]">
                  ...
                  <li><strong>عهد الأجهزة والمعدات:</strong> الحفاظ على سلامة أجهزة التتبع أو الهواتف الذكية المُسلمة من المنصة، وتحمل تكلفة صيانة أو استبدال الجهاز في حال التلف الناتج عن التقصير.</li>
