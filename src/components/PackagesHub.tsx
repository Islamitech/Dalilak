...
export const PackagesHub: React.FC = () => {
  ...
  const detailedPackages = [
    {
      ...
      highlights: [
        ...
        '🎁 هدية خاصة: تصميم ملصق باركود احترافي للخريطة للطباعة'
      ],
      featuresIncluded: [
        ...
        { name: '🎁 هدية: تصميم ملصق باركود (QR) للمحل', desc: 'تصميم ملصق باركود احترافي لموقع الخريطة بعد توثيقه مخصص للنشاط وجاهز للطباعة والتعليق (ويمكن إرسال التصاميم جاهزة ومطبوعة بـ 100 جنيه إضافية).' }
      ],
      idealPractices: [
    ...
    },
    {
      ...
      summary: 'إدارة رقمية وتسويقية متكاملة: تصميمات دورية، ضبط الحملات الإعلانية، حماية السمعة، ودعم يومي لمدة شهر.',
      deliveryTime: 'شهر كامل (30 يوماً)',
      targetAudience: 'المبتدئين وأصحاب الأعمال المشغولين الذين يريدون فريقاً تسويقياً يتولى عنهم إدارة المنصات وضبط الإعلانات ومتابعة الزبائن.',
      highlights: [
        'كل ميزات باقة التأسيس وتوثيق خرائط جوجل',
        'خطة تسويقية وتصميم بوستات وبانرات متجددة طوال الشهر',
        'تجهيز وضبط الحملات الممولة (ميزانية الإعلانات يحددها ويسددها العميل للمنصات مباشرة)',
      ...
      featuresIncluded: [
        ...
        { name: 'إعداد واستهداف الحملات الإعلانية الممولة', desc: 'ضبط الإعلانات واستهداف سكان النطاق الجغرافي بأقل تكلفة (ميزانية الإعلانات يحددها ويسددها العميل للمنصات مباشرة حسب قدرته).' },
        { name: 'تدريب عملي خطوة بخطوة لصاحب النشاط', desc: 'تعليمك كيفية إدارة الصفحات، الرد السريع، ورفع المبيعات بنفسك.' },
      ...
      idealPractices: [
        ...
        '📈 أفضل استفادة: التنسيق اليومي مع المستشار التسويقي لمتابعة تفاعل الزبائن وتطوير العروض.'
      ]
    }
  ];
  ...
  const comparisonRows = [
    ...
    {
      feature: 'إعداد وضبط الحملات الإعلانية الممولة جغرافياً',
      basic: false,
      pro: false,
      vip: true,
    },
