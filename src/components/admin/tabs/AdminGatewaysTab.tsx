      ...
      <div className="space-y-3 text-xs">
        ...
        <div className="bg-emerald-500/10 p-4 rounded-2xl border border-emerald-500/30 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-emerald-500/20 text-emerald-700 text-xs font-black px-3 py-1.5 rounded-xl border border-emerald-500/30">
              E-Wallets
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
            <div className="bg-[var(--input-bg)] p-3 rounded-xl border border-emerald-500/30 flex items-center justify-between">
              <div>
                ...
                <span className="text-emerald-700 font-mono font-black text-base dir-ltr text-right inline-block">
                  {paymentConfig.vodafoneCashNumber || '01143888355'}
                </span>
              </div>
              <span className="text-[10px] font-bold bg-emerald-500/15 text-emerald-600 px-2 py-0.5 rounded-md">رئيسي</span>
            </div>
            ...
            <div className="bg-[var(--input-bg)] p-3 rounded-xl border border-emerald-500/30 flex items-center justify-between">
              ...
              <span className="text-[10px] font-bold bg-emerald-500/15 text-emerald-600 px-2 py-0.5 rounded-md">إضافي</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-purple-500/10 p-4 rounded-2xl border border-purple-500/30 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-purple-500/20 text-purple-700 text-xs font-black px-3 py-1.5 rounded-xl border border-purple-500/30">
              InstaPay
            </span>
          </div>
          ...
          <div className="bg-[var(--input-bg)] p-3 rounded-xl border border-purple-500/30 flex items-center justify-between">
            <div>
              ...
              <span className="text-purple-700 font-mono font-black text-base dir-ltr text-right inline-block">
                {paymentConfig.instaPayHandle || '@daz31181'}
              </span>
            </div>
            <span className="text-[10px] font-bold bg-purple-500/15 text-purple-600 px-2.5 py-1 rounded-md">حساب رسمي معتمد</span>
          </div>
        </div>
