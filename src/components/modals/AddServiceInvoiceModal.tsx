...
export const AddServiceInvoiceModal: React.FC<AddServiceInvoiceModalProps> = ({
  ...
  return createPortal(
    <OverlayLayer className="fixed inset-0 z-[10040] bg-slate-900/50 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto" dir="rtl">
