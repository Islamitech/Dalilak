...
export function generateTrendingFreeInvitationWhatsAppMessage(biz: Business): string {
  ...
  const raw =
    ...
    `4. معرض صور فائق الجودة يعرض مميزات منشأتكم مجاناً بالكامل\n\n` +
    `💡 *خدمات دليلك الإعلانية:* بجانب الدليل المجاني التام، نوفر خدمات التسويق، مونتاج الفيديو Reels، وتعزيز الظهور الرقمي بأعلى جودة احترافية وبأسعار رمزية ومخفضة جداً.\n\n` +
