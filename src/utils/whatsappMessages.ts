...
export function generateQrImportanceWhatsAppMessage(biz: Business): string {
  const raw = 
    `*📲 ما أهمية وجود QR Code داخل النشاط (${biz.nameAr})؟*\n` +
    `-----------------------------------------\n` +
    `أهلاً بحضرتك أستاذ *${biz.ownerName || 'صاحب النشاط'}*،\n\n` +
    `وجود QR Code في مكان واضح داخل النشاط يسهّل على العميل الوصول إلى صفحة النشاط على خرائط Google دون الحاجة إلى البحث عنها يدويًا.\n\n` +
    `*يمكن للعميل من خلاله:*\n` +
    `• الوصول إلى موقع النشاط ومعلوماته.\n` +
    `• الاطلاع على تقييمات وتجارب العملاء الآخرين.\n` +
    `• تقييم النشاط بعد تجربته مباشرة.\n\n` +
    `وبالنسبة لصاحب النشاط، فإن وضع QR Code داخل المكان يوفّر طريقة بسيطة ومباشرة لتسهيل وصول العملاء إلى نشاطه على خرائط Google، وإتاحة فرصة أكبر للحصول على تقييمات من العملاء الذين تعاملوا معه فعليًا.\n\n` +
    `لذلك يُفضّل وضعه في مكان واضح وسهل الوصول، خصوصًا في الأماكن التي ينتظر فيها العميل مثل الكاشير او مقاعد الانتظار وشرب القهوة أو بعد إتمام الخدمة عند مخرج الباب اثناء خروج .\n\n` +
